...
namespace Library.Services
{
    public class LibraryRepository : ILibraryRepository
    {
        ...
        public void AddBookForAuthor(Guid authorId, Book book)
        {
            ...
            if (author != null)
            {
                // eğer id alanı boş ise burada upserting yapmıyoruz
                // yani yeni bir kitap oluşturuyoruz
                if (book.Id == null)
                {
                    book.Id = Guid.NewGuid();
                }

                // eğer yukarıdaki belirtilen if bloğuna girilmemişse
                // kitabın id si dışarıdan verilmiş, yani route'dan gelmiştir. 
                // öyleyse id alanına sahiptir ve kitabı direk ekliyoruz
