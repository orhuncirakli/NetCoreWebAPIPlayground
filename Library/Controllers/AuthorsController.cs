...
namespace Library.Controllers
{
    ...
    public class AuthorsController : Controller
    {
        ...
        [RequestHeaderMatchesMediaType("Content-Type", new[] { "application/vnd.orhun.author.full+json" })]
        public IActionResult CreateAuthor([FromBody] AuthorForCreationDto author)
        {
            ...
            var linkedResourceToReturn = authorToReturn.ShapeData<AuthorDto>(null) as IDictionary<string, object>;
            linkedResourceToReturn.Add("links", links);
        ...
        [RequestHeaderMatchesMediaTypeAttribute("Content-Type", new[] { "application/vnd.orhun.authorwithdateofdeath.full+json",
        "application/vnd.orhun.authorwithdateofdeath.full+xml"})]
